...
template<typename Stream, typename T, typename A, typename V, typename K, typename C, typename N> void Serialize(Stream& os, const boost::variant<T, A, V, K, C, N>& v);
template<typename Stream, typename T, typename A, typename V, typename K, typename C, typename N> void Unserialize(Stream& is, boost::variant<T, A, V, K, C, N>& v);
